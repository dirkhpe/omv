"""
This script will get collect the comments with "???" in a html table. Purpose is to export to excel (or can I write to
excel in one go, including CR in comment fields?
"""
